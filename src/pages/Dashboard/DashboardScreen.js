        ...
        <div className="col-xl-8 col-lg-7">
          <div className="row">
            <div className="col-sm-4">
              <div className="card overflow-hidden">
                <div className="card-header p-3 pb-0">
                  <p className="text-sm mb-0 text-capitalize font-weight-bold">Visitors</p>
            ...
            <div className="col-sm-4 mt-sm-0 mt-4">
              <div className="card overflow-hidden">
                <div className="card-header p-3 pb-0">
                  <p className="text-sm mb-0 text-capitalize font-weight-bold">Income</p>
                  <h5 className="font-weight-bolder mb-0">
                    $130,832
            ...
            <div className="col-sm-4 mt-sm-0 mt-4">
              <div className="card border h-100">
                <div className="card-body d-flex flex-column justify-content-center text-center">
                  <a href="javascript:;">
                    <i className="fa fa-plus text-secondary text-sm mb-1" aria-hidden="true"></i>
                    <h6 className="text-secondary"> New tab </h6>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div className="card p-3">
                ...
                >
                  ...
                  <div className="card-body position-relative z-index-1 h-100 p-3">
                    <h6 className="text-white font-weight-bolder mb-3">Hey John!</h6>
                    <p className="text-white mb-3">Wealth creation is an evolutionarily recent positive-sum game. It is all about who take the opportunity first.</p>
                ...
                <div className="card-body p-3">
                  <ul className="list-group">
                    <li className="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div className="d-flex align-items-center">
                        <div className="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" className="mt-1">
                    ...
                    <li className="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                      <div className="d-flex align-items-center">
                        <div className="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" className="mt-1">
                ...
                <div className="card-body p-3">
                  <div className="row">
                    ...
                    <div className="col-8 my-auto">
                      <p className="text-muted text-sm font-weight-bold">Today is Martina's birthday. Wish her the best of luck!</p>
